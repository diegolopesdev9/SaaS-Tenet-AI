...
@router.post("/{tenet_id}/test/{crm_type}")
async def test_integration(
    ...
    is_connected = await crm_service.test_integration(tenet_id, crm_type)
...
@router.delete("/{tenet_id}/{crm_type}")
...
@router.patch("/{tenet_id}/{crm_type}/toggle")
async def toggle_integration(
    ...
    try:
        ...
        }).eq("tenet_id", tenet_id).eq("crm_type", crm_type).execute()
